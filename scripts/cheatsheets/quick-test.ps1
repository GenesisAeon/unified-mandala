<#
  scripts/cheatsheets/quick-test.ps1
  Re-Entry Testflow für Unified-Mandala (Windows PowerShell)

  Nutzung:
    - Plan A (ohne API-Key):  .\scripts\cheatsheets\quick-test.ps1 -Mode A
    - Plan B (mit API-Key) :  .\scripts\cheatsheets\quick-test.ps1 -Mode B -ApiKey 'dev-key'
#>
...
# Windows PowerShell 5.1 hat keinen ternary-Operator – effektiven Key explizit setzen
$effectiveApiKey = ''
