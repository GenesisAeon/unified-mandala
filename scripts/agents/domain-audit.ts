...
const policy = yaml.parse(fs.readFileSync(path.resolve("governance/policies/agents-policy.yaml"),"utf8"));
...
function domainFromUrl(u:string){ try { return new URL(u).hostname.toLowerCase(); } catch{ return ""; } }
