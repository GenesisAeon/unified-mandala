...
const src =
  process.env.ZIP_SRC || path.join(__dirname, '../docs/sigils/newadvancedconversations.json');
const destRoot =
  process.env.ZIP_DEST || path.join(__dirname, '../GenesisAeonZIPMEM/newadvancedconversations');
