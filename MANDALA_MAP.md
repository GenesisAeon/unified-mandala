...
Noch nicht vertieft in `docs/`: `docs/personhood`, `docs/aeon-seal-ai`,
`docs/go-agent`, `docs/sigillin`+`docs/sigils` (Dokumentation, nicht
die großen JSON-Rohdaten), `docs/genesis`, `docs/mandala`,
