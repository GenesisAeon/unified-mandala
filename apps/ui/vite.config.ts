...
const realtimeWs =
  process.env.VITE_REALTIME_WS ?? `ws://localhost:${realtimePort}/ws?topic=demo.cosmic`;
const realtimeSse =
  process.env.VITE_REALTIME_SSE ?? `http://localhost:${realtimePort}/sse?topic=demo.cosmic`;
