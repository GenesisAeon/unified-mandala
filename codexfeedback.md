...
- FR-UM-2025-10-14-Fraktal56-WindowsBootstrap: Neues PowerShell-Setup (`scripts/setup-dev-env.ps1`) installiert Git/Node/Python samt Corepack-Fallback, `pnpm build:windows-tools` nutzt jetzt `scripts/run-powershell.mjs` als pwsh/powershell-Wrapper und README/Onboarding/Command-Catalog/MandalaMap spiegeln Windows-Parität.
