...
- FR-UM-2025-10-20-Fraktal56-JetStreamReady: JetStream-Wächter (`packages/event-bus/jetstream-utils.ts`) liefern verständliche Fehlermeldungen, `pnpm nats:doctor` + `docs/runbooks/nats-jetstream.md` dokumentieren Setup & Checks; Command-Catalog/MandalaMap/README/Onboarding verlinken den Flow.
