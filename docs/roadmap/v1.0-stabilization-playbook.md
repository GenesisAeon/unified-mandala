...
3. **Sigillin Governance**
   - `pnpm validate:sigillins` nutzt `scripts/sigillin/validate-sigillins.ts` + Schema (`mandala-sigillin.schema.json`); CI-Workflow `sigillin-validate` blockt fehlende CREP/Trikāya/NEXT Angaben.
