...
1. **Core-Gates härten**
   ...
   - _Status 2025-09-30:_ Core läuft fail-fast inkl. Toolchain-Artefakt; Nightly-Matrix spiegelt Core und wird aktiv ausgewertet.
2. **Extended-/Experimental-Schicht**
   ...
   - _Status 2025-09-30:_ Experimental/Extended-Jobs laufen stabil (Node 20, Coverage aktiv), Alerts & Reviews im Nightly-Loop.
...
2. **Dead Code & Skript-Konsolidierung**
   ...
   - _Status 2025-09-30:_ `scripts/run-dist.mjs` produktiv, README/CONTRIBUTING/ONBOARDING dokumentieren Dist-First inkl. neuer Dev-Flows.
...
1. **Dist-First Strategie**
   ...
   - _Status 2025-09-30:_ Node20/Python3-Basis verankert; Dist-First-Kommandos in Prod-/Compose-Pfaden bestätigt.
2. **Runtime Smoke Tests**
   ...
   - _Status 2025-09-30:_ `pnpm smoke:light-static` und `smoke:ttfb` laufen im Release-Drill, Ergebnisdoku in Fraktal44.
...
3. **Docker/Compose Integration**
   ...
   - _Status 2025-09-30:_ Compose-Profile (`core`, `newsbot`, `climate`, `llm`, `global`, `agents`, `monitoring`) produktiv erprobt.
...
2. **Dokumentation**
   ...
   - _Status 2025-09-30:_ Entscheidungsbeispiele verankert, Governance-Review-Prozess dokumentiert und aktiv.
...
- _Status 2025-09-30:_ Compose-Profil `monitoring` aktiv im Release-Drill, `/metrics`-Smoke und Alerts dokumentiert.
