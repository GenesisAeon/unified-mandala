...
1. **README / CONTRIBUTING / ONBOARDING**
   ...
   - _Status 2025-10-19:_ README & Tests-Runbook referenzieren `pnpm nats:docker` und `pnpm dev:ports:free`; das Emergence-Scan-Skript fällt auf `docs/sigillin/GENESIS.md` zurück, wenn `SIGILLIN_GENESIS.md` noch nicht angelegt wurde.
