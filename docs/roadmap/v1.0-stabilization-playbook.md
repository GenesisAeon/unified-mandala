...
3. **Agent-/Service-Workflows**
   ...
   - _Status 2025-09-22:_ Node-Setup auf 20.x migriert, dist-first CLI via `scripts/run-dist.mjs` verdrahtet und Policy-Suite im Agent-Workflow aktiviert.【F:ci/agent.yml†L18-L33】【F:scripts/run-dist.mjs†L1-L46】【F:package.json†L70-L79】
...
1. **Dist-First Strategie**
   ...
   - _Status 2025-09-22:_ Agents-Skripte laufen über `scripts/run-dist.mjs`, CI-Health-Checks bauen Dist-Artefakte vor dem Lauf.【F:scripts/run-dist.mjs†L1-L46】【F:.github/workflows/ci.experimental.yml†L20-L29】
...
2. **Dokumentation**
   ...
   - _Status 2025-09-22:_ Beispiele für Allow/Review/Deny ergänzt und Guardrail-Fehlerausgabe dokumentiert.【F:AI_POLICY.md†L21-L34】【F:AI_POLICY.yaml†L1-L27】
