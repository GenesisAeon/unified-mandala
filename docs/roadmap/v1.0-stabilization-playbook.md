...
1. **Core-Gates härten**
   ...
   - _Status 2025-10-19 (Fraktal57):_ JetStream-Bus-Test läuft unter Vitest, CI-Core startet einen Docker-basierten NATS-Server, ruft `pnpm nats:doctor` und `pnpm test:jetstream` als Teil des type-and-tests-Gates auf.
