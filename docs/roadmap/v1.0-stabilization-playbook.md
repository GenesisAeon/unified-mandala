...
2. **Dead Code & Skript-Konsolidierung**
   ...
   - _Status 2025-09-22:_ `scripts/run-dist-entry.mjs` ersetzt `ts-node` für Produktionsskripte; README/CONTRIBUTING beschreiben den Dist-Runner und Dist-first-Guidelines.
...
2. **Dokumentation**
   ...
   - _Status 2025-09-22:_ Allow/Review/Deny-Beispiele ergänzt und Guardrail-Diagnostik dokumentiert.
...
1. **README / CONTRIBUTING / ONBOARDING**
   ...
   - _Status 2025-09-22:_ README & CONTRIBUTING weisen auf den Dist-Runner (`scripts/run-dist-entry.mjs`) hin und betonen den Verzicht auf `ts-node` in Produktionspfaden.
