...
1. **Lint/Format-Disziplin**
   ...
   - JetStream-Runbook (`docs/runbooks/nats-jetstream.md`) und `pnpm nats:doctor` verankern lokale NATS/JetStream-Parität für `pnpm start:all` in Doku & Command-Catalog.
